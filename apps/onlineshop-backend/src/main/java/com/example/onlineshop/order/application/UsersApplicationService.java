package com.example.onlineshop.order.application;
...
import com.example.onlineshop.order.domain.user.service.UserReader;
import com.example.onlineshop.order.domain.user.service.UserSynchronizer;
...
import com.example.onlineshop.order.infrastructure.secondary.service.kinde.KindeService;
import com.example.onlineshop.shared.authentication.application.AuthenticatedUser;
